// Department maintains a student 
// information. The file contains roll 
// number, name, division and 
// address. Allow user to add, delete 
// information of student. Display 
// information of particular student. If 
// record of student does not exist an 
// appropriate message is displayed. 
// If it is, then the system displays the 
// student details. Use sequential file 
// to main the data
#include<iostream>
#include<fstream>
#include<cstring>
